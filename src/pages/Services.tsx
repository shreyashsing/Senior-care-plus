  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50">
        ...
        {/* Contact Section */}
        <section className="py-20 px-4 bg-gradient-to-r from-emerald-600 via-green-600 to-emerald-700">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6">
              Ready to Experience Better Healthcare?
            </h2>
            <p className="text-lg text-emerald-100 mb-8 leading-relaxed">
              Contact our medical experts to learn more about our comprehensive healthcare services.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-8">
              ...
              <div className="flex items-center gap-3 bg-white/10 backdrop-blur-sm px-6 py-4 rounded-xl border border-white/20">
                ...
                <span className="font-semibold text-white">Expert Medical Team</span>
              </div>
            </div>
